...
outliers = outlier_id(diff_am_lg)
temp = temp[-outliers,]
...
# scale values
temp = temp[-outlier_id(diff_am_lg),]
...
```{r}
saveRDS(model_list, file = paste0(wd, 'results/paired_ARUs/corrected_data/lm_paired_ARU_models-no_outlier_rm.rds'))
```

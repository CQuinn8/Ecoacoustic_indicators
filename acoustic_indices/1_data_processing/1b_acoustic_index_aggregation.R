# Purpose : Use site csvs of all melspec ABGQI preds to generate by-in, by-hour, and by-site data
...
results_dir = '/projects/tropics/users/cquinn/s2l/paper1-AcousticIndices/results/acoustic_indices_aggregation/'

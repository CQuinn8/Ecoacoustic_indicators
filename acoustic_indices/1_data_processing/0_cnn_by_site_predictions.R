...
f = "075"
results_dir = '/projects/tropics/users/cquinn/s2l/paper1-SpatialMapping/results/ABGQI_inference/'
inference_dir = '/projects/tropics/users/cquinn/s2l/paper0-ABGOQ_classification/results_avec_2021/cnn_inference_nonXC/'
...
abg_df = read.csv('/projects/tropics/users/cquinn/s2l/paper0-ABGOQ_classification/data/cnn_training/verfied_ROIs_thru_5460.csv')
...
for(target_label in labels){
  ...
  th_df = read.csv(paste0('/scratch/cq73/projects/S2L/abg_cnn/results/CNN_inference/local_PC_results/IMGNET_S2L_withFreesound-local/performance_fscore_', f, "/", 
                          target_label, 
...
error_log <- paste0('/projects/tropics/users/cquinn/s2l/paper1-SpatialMapping/results/ABGQI_inference/error_logs.txt')
